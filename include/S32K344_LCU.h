...
typedef struct {
  struct {                                         /* offset: 0x0, array step: 0x40 */
    __IO uint32_t LUTCTRL0;                          /**< LC 0 Output 0 LUT Control..LC 2 Output 0 LUT Control, array offset: 0x0, array step: 0x40 */
    __IO uint32_t LUTCTRL1;                          /**< LC 0 Output 1 LUT Control..LC 2 Output 1 LUT Control, array offset: 0x4, array step: 0x40 */
    __IO uint32_t LUTCTRL2;                          /**< LC 0 Output 2 LUT Control..LC 2 Output 2 LUT Control, array offset: 0x8, array step: 0x40 */
    __IO uint32_t LUTCTRL3;                          /**< LC 0 Output 3 LUT Control..LC 2 Output 3 LUT Control, array offset: 0xC, array step: 0x40 */
    __IO uint32_t FILT0;                             /**< LC 0 Output 0 Filter..LC 2 Output 0 Filter, array offset: 0x10, array step: 0x40 */
    __IO uint32_t FILT1;                             /**< LC 0 Output 1 Filter..LC 2 Output 1 Filter, array offset: 0x14, array step: 0x40 */
    __IO uint32_t FILT2;                             /**< LC 0 Output 2 Filter..LC 2 Output 2 Filter, array offset: 0x18, array step: 0x40 */
    __IO uint32_t FILT3;                             /**< LC 0 Output 3 Filter..LC 2 Output 3 Filter, array offset: 0x1C, array step: 0x40 */
...
/*! @name LUTCTRL0 - LC 0 Output 0 LUT Control..LC 2 Output 0 LUT Control */
/*! @{ */
#define LCU_LUTCTRL0_LUTCTRL_MASK                (0xFFFFU)
#define LCU_LUTCTRL0_LUTCTRL_SHIFT               (0U)
#define LCU_LUTCTRL0_LUTCTRL_WIDTH               (16U)
#define LCU_LUTCTRL0_LUTCTRL(x)                  (((uint32_t)(((uint32_t)(x)) << LCU_LUTCTRL0_LUTCTRL_SHIFT)) & LCU_LUTCTRL0_LUTCTRL_MASK)
/*! @} */

/*! @name LUTCTRL1 - LC 0 Output 1 LUT Control..LC 2 Output 1 LUT Control */
/*! @{ */
#define LCU_LUTCTRL1_LUTCTRL_MASK                (0xFFFFU)
#define LCU_LUTCTRL1_LUTCTRL_SHIFT               (0U)
#define LCU_LUTCTRL1_LUTCTRL_WIDTH               (16U)
#define LCU_LUTCTRL1_LUTCTRL(x)                  (((uint32_t)(((uint32_t)(x)) << LCU_LUTCTRL1_LUTCTRL_SHIFT)) & LCU_LUTCTRL1_LUTCTRL_MASK)
/*! @} */

/*! @name LUTCTRL2 - LC 0 Output 2 LUT Control..LC 2 Output 2 LUT Control */
/*! @{ */
#define LCU_LUTCTRL2_LUTCTRL_MASK                (0xFFFFU)
#define LCU_LUTCTRL2_LUTCTRL_SHIFT               (0U)
#define LCU_LUTCTRL2_LUTCTRL_WIDTH               (16U)
#define LCU_LUTCTRL2_LUTCTRL(x)                  (((uint32_t)(((uint32_t)(x)) << LCU_LUTCTRL2_LUTCTRL_SHIFT)) & LCU_LUTCTRL2_LUTCTRL_MASK)
/*! @} */

/*! @name LUTCTRL3 - LC 0 Output 3 LUT Control..LC 2 Output 3 LUT Control */
/*! @{ */
#define LCU_LUTCTRL3_LUTCTRL_MASK                (0xFFFFU)
#define LCU_LUTCTRL3_LUTCTRL_SHIFT               (0U)
#define LCU_LUTCTRL3_LUTCTRL_WIDTH               (16U)
#define LCU_LUTCTRL3_LUTCTRL(x)                  (((uint32_t)(((uint32_t)(x)) << LCU_LUTCTRL3_LUTCTRL_SHIFT)) & LCU_LUTCTRL3_LUTCTRL_MASK)
/*! @} */

/*! @name FILT0 - LC 0 Output 0 Filter..LC 2 Output 0 Filter */
/*! @{ */
#define LCU_FILT0_LUT_FALL_FILT_MASK             (0xFFFFU)
#define LCU_FILT0_LUT_FALL_FILT_SHIFT            (0U)
#define LCU_FILT0_LUT_FALL_FILT_WIDTH            (16U)
#define LCU_FILT0_LUT_FALL_FILT(x)               (((uint32_t)(((uint32_t)(x)) << LCU_FILT0_LUT_FALL_FILT_SHIFT)) & LCU_FILT0_LUT_FALL_FILT_MASK)
#define LCU_FILT0_LUT_RISE_FILT_MASK             (0xFFFF0000U)
#define LCU_FILT0_LUT_RISE_FILT_SHIFT            (16U)
#define LCU_FILT0_LUT_RISE_FILT_WIDTH            (16U)
#define LCU_FILT0_LUT_RISE_FILT(x)               (((uint32_t)(((uint32_t)(x)) << LCU_FILT0_LUT_RISE_FILT_SHIFT)) & LCU_FILT0_LUT_RISE_FILT_MASK)
/*! @} */

/*! @name FILT1 - LC 0 Output 1 Filter..LC 2 Output 1 Filter */
/*! @{ */
#define LCU_FILT1_LUT_FALL_FILT_MASK             (0xFFFFU)
#define LCU_FILT1_LUT_FALL_FILT_SHIFT            (0U)
#define LCU_FILT1_LUT_FALL_FILT_WIDTH            (16U)
#define LCU_FILT1_LUT_FALL_FILT(x)               (((uint32_t)(((uint32_t)(x)) << LCU_FILT1_LUT_FALL_FILT_SHIFT)) & LCU_FILT1_LUT_FALL_FILT_MASK)
#define LCU_FILT1_LUT_RISE_FILT_MASK             (0xFFFF0000U)
#define LCU_FILT1_LUT_RISE_FILT_SHIFT            (16U)
#define LCU_FILT1_LUT_RISE_FILT_WIDTH            (16U)
#define LCU_FILT1_LUT_RISE_FILT(x)               (((uint32_t)(((uint32_t)(x)) << LCU_FILT1_LUT_RISE_FILT_SHIFT)) & LCU_FILT1_LUT_RISE_FILT_MASK)
/*! @} */

/*! @name FILT2 - LC 0 Output 2 Filter..LC 2 Output 2 Filter */
/*! @{ */
#define LCU_FILT2_LUT_FALL_FILT_MASK             (0xFFFFU)
#define LCU_FILT2_LUT_FALL_FILT_SHIFT            (0U)
#define LCU_FILT2_LUT_FALL_FILT_WIDTH            (16U)
#define LCU_FILT2_LUT_FALL_FILT(x)               (((uint32_t)(((uint32_t)(x)) << LCU_FILT2_LUT_FALL_FILT_SHIFT)) & LCU_FILT2_LUT_FALL_FILT_MASK)
#define LCU_FILT2_LUT_RISE_FILT_MASK             (0xFFFF0000U)
#define LCU_FILT2_LUT_RISE_FILT_SHIFT            (16U)
#define LCU_FILT2_LUT_RISE_FILT_WIDTH            (16U)
#define LCU_FILT2_LUT_RISE_FILT(x)               (((uint32_t)(((uint32_t)(x)) << LCU_FILT2_LUT_RISE_FILT_SHIFT)) & LCU_FILT2_LUT_RISE_FILT_MASK)
/*! @} */

/*! @name FILT3 - LC 0 Output 3 Filter..LC 2 Output 3 Filter */
/*! @{ */
#define LCU_FILT3_LUT_FALL_FILT_MASK             (0xFFFFU)
#define LCU_FILT3_LUT_FALL_FILT_SHIFT            (0U)
#define LCU_FILT3_LUT_FALL_FILT_WIDTH            (16U)
#define LCU_FILT3_LUT_FALL_FILT(x)               (((uint32_t)(((uint32_t)(x)) << LCU_FILT3_LUT_FALL_FILT_SHIFT)) & LCU_FILT3_LUT_FALL_FILT_MASK)
#define LCU_FILT3_LUT_RISE_FILT_MASK             (0xFFFF0000U)
#define LCU_FILT3_LUT_RISE_FILT_SHIFT            (16U)
#define LCU_FILT3_LUT_RISE_FILT_WIDTH            (16U)
#define LCU_FILT3_LUT_RISE_FILT(x)               (((uint32_t)(((uint32_t)(x)) << LCU_FILT3_LUT_RISE_FILT_SHIFT)) & LCU_FILT3_LUT_RISE_FILT_MASK)
/*! @} */
