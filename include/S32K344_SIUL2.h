...
typedef struct {
  ...
  uint8_t RESERVED_8[316];
       uint32_t MIDR3;                             /**< SIUL2 MCU ID Register 3, offset: 0x200 */
       uint32_t MIDR4;                             /**< SIUL2 MCU ID Register 4, offset: 0x204 */
