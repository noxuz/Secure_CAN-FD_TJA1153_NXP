...
typedef struct {
  ...
  __IO uint32_t MCRS;                              /**< Module Configuration Status Register, offset: 0x4 */
  __I  uint32_t MCRE;                              /**< Extended Module Configuration Register, offset: 0x8 */
  __IO uint32_t CTL;                               /**< Module Control Register, offset: 0xC */
  __IO uint32_t ADR;                               /**< Address register, offset: 0x10 */
  __I  uint32_t PEADR;                             /**< Program and Erase Address register, offset: 0x14 */
  uint8_t RESERVED_0[8];
  __IO uint32_t AMCR;                              /**< Alternate Module Configuration Register, offset: 0x20 */
  __IO uint32_t AMCRS;                             /**< Alternate Module Configuration Status Register, offset: 0x24 */
  __I  uint32_t APEADR;                            /**< Alternate Program and Erase Address register, offset: 0x28 */
  uint8_t RESERVED_1[4];
  __IO uint32_t ADATA[FLASH_ADATA_COUNT];          /**< Alternate Program Data Register, array offset: 0x30, array step: 0x4 */
  __I  uint32_t SPELOCK;                           /**< Sector Program and Erase Hardware Lock register, offset: 0x50 */
  __I  uint32_t SSPELOCK;                          /**< Super Sector Program and Erase Hardware Lock register, offset: 0x54 */
  uint8_t RESERVED_2[8];
  __I  uint32_t ASPELOCK;                          /**< Alternate Sector Program and Erase Hardware Lock register, offset: 0x60 */
  __I  uint32_t ASSPELOCK;                         /**< Alternate Super Sector Program and Erase Hardware Lock register, offset: 0x64 */
  uint8_t RESERVED_3[8];
  __I  uint32_t XSPELOCK;                          /**< Express Sector Program and Erase Hardware Lock register, offset: 0x70 */
  __I  uint32_t XSSPELOCK;                         /**< Express Super Sector Program and Erase Hardware Lock register, offset: 0x74 */
  uint8_t RESERVED_4[24];
  __IO uint32_t TMD;                               /**< Test Mode Disable Password Check register, offset: 0x90 */
  __IO uint32_t UT0;                               /**< UTest 0 register, offset: 0x94 */
  __IO uint32_t UM[FLASH_UM_COUNT];                /**< UMISRn register, array offset: 0x98, array step: 0x4 */
  __IO uint32_t UM9;                               /**< UMISR9 register, offset: 0xBC */
  uint8_t RESERVED_5[16];
  __IO uint32_t UD0;                               /**< UTest Data 0 Register, offset: 0xD0 */
  __IO uint32_t UD1;                               /**< UTest Data 1 Register, offset: 0xD4 */
  __IO uint32_t UD2;                               /**< UTest Data 2 Register, offset: 0xD8 */
  __IO uint32_t UD3;                               /**< UTest Data 3 Register, offset: 0xDC */
  __IO uint32_t UD4;                               /**< UTest Data 4 Register, offset: 0xE0 */
  __IO uint32_t UD5;                               /**< UTest Data 5 Register, offset: 0xE4 */
  __IO uint32_t UA0;                               /**< UTest Address 0 Register, offset: 0xE8 */
  __IO uint32_t UA1;                               /**< UTest Address 1 Register, offset: 0xEC */
  __IO uint32_t XMCR;                              /**< Express Module Configuration Register, offset: 0xF0 */
  __I  uint32_t XPEADR;                            /**< Express Program Address register, offset: 0xF4 */
  uint8_t RESERVED_6[8];
  __IO uint32_t DATA[FLASH_DATA_COUNT];            /**< Program Data Register, array offset: 0x100, array step: 0x4 */
...
/*! @name MCRS - Module Configuration Status Register */
/*! @{ */
...
/*! @name CTL - Module Control Register */
/*! @{ */
...
/*! @name PEADR - Program and Erase Address register */
/*! @{ */
...
/*! @name AMCR - Alternate Module Configuration Register */
/*! @{ */
...
/*! @name AMCRS - Alternate Module Configuration Status Register */
/*! @{ */
...
/*! @name APEADR - Alternate Program and Erase Address register */
/*! @{ */
...
/*! @name ADATA - Alternate Program Data Register */
/*! @{ */
...
/*! @name SPELOCK - Sector Program and Erase Hardware Lock register */
/*! @{ */
...
/*! @name SSPELOCK - Super Sector Program and Erase Hardware Lock register */
/*! @{ */
...
/*! @name ASPELOCK - Alternate Sector Program and Erase Hardware Lock register */
/*! @{ */
...
/*! @name ASSPELOCK - Alternate Super Sector Program and Erase Hardware Lock register */
/*! @{ */
...
/*! @name XSPELOCK - Express Sector Program and Erase Hardware Lock register */
/*! @{ */
...
/*! @name XSSPELOCK - Express Super Sector Program and Erase Hardware Lock register */
/*! @{ */
...
/*! @name UD0 - UTest Data 0 Register */
/*! @{ */
...
/*! @name UD1 - UTest Data 1 Register */
/*! @{ */
...
/*! @name UD2 - UTest Data 2 Register */
/*! @{ */
...
/*! @name UD3 - UTest Data 3 Register */
/*! @{ */
...
/*! @name UD4 - UTest Data 4 Register */
/*! @{ */
...
/*! @name UD5 - UTest Data 5 Register */
/*! @{ */
...
/*! @name UA0 - UTest Address 0 Register */
/*! @{ */
...
/*! @name UA1 - UTest Address 1 Register */
/*! @{ */
...
/*! @name XMCR - Express Module Configuration Register */
/*! @{ */
...
/*! @name XPEADR - Express Program Address register */
/*! @{ */
...
/*! @name DATA - Program Data Register */
/*! @{ */
