...
#define STCU_CTRL_PFT_MASK                       (0x40U)
#define STCU_CTRL_PFT_SHIFT                      (6U)
#define STCU_CTRL_PFT_WIDTH                      (1U)
#define STCU_CTRL_PFT(x)                         (((uint32_t)(((uint32_t)(x)) << STCU_CTRL_PFT_SHIFT)) & STCU_CTRL_PFT_MASK)
