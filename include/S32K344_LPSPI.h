...
typedef struct {
  ...
  __IO uint32_t CCR1;                              /**< Clock Configuration Register 1, offset: 0x44 */
  ...
  __I  uint32_t RDROR;                             /**< Receive Data Read Only Register, offset: 0x78 */
  uint8_t RESERVED_5[896];
  __O  uint32_t TCBR;                              /**< Transmit Command Burst Register, offset: 0x3FC */
  __O  uint32_t TDBR;                              /**< Transmit Data Burst Register, offset: 0x400 */
  uint8_t RESERVED_6[508];
  __I  uint32_t RDBR;                              /**< Receive Data Burst Register, offset: 0x600 */
...
/*! @name CCR1 - Clock Configuration Register 1 */
/*! @{ */
...
/*! @name RDROR - Receive Data Read Only Register */
/*! @{ */
...
/*! @name RDBR - Receive Data Burst Register */
/*! @{ */
