...
#define CONFIGURATION_GPR_CONFIG_REG6_ENET_CLOCK_GATE_MASK (0x4U)
#define CONFIGURATION_GPR_CONFIG_REG6_ENET_CLOCK_GATE_SHIFT (2U)
#define CONFIGURATION_GPR_CONFIG_REG6_ENET_CLOCK_GATE_WIDTH (1U)
#define CONFIGURATION_GPR_CONFIG_REG6_ENET_CLOCK_GATE(x) (((uint32_t)(((uint32_t)(x)) << CONFIGURATION_GPR_CONFIG_REG6_ENET_CLOCK_GATE_SHIFT)) & CONFIGURATION_GPR_CONFIG_REG6_ENET_CLOCK_GATE_MASK)
