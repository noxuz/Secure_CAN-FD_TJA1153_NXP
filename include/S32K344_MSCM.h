...
typedef struct {
  __IO uint32_t CPXTYPE;                           /**< Processor X Type, offset: 0x0 */
  __IO uint32_t CPXNUM;                            /**< Processor X Number, offset: 0x4 */
  __IO uint32_t CPXREV;                            /**< Processor X Revision, offset: 0x8 */
  __IO uint32_t CPXCFG0;                           /**< Processor X Configuration 0, offset: 0xC */
  __IO uint32_t CPXCFG1;                           /**< Processor X Configuration 1, offset: 0x10 */
  __IO uint32_t CPXCFG2;                           /**< Processor X Configuration 2, offset: 0x14 */
  __IO uint32_t CPXCFG3;                           /**< Processor x Configuration 3, offset: 0x18 */
  uint8_t RESERVED_0[4];
  __IO uint32_t CP0TYPE;                           /**< Processor 0 Type, offset: 0x20 */
  __IO uint32_t CP0NUM;                            /**< Processor 0 Number, offset: 0x24 */
  __IO uint32_t CP0REV;                            /**< Processor 0 Count, offset: 0x28 */
  __IO uint32_t CP0CFG0;                           /**< Processor 0 Configuration 0, offset: 0x2C */
  __IO uint32_t CP0CFG1;                           /**< Processor 0 Configuration 1, offset: 0x30 */
  __IO uint32_t CP0CFG2;                           /**< Processor 0 Configuration 2, offset: 0x34 */
  __IO uint32_t CP0CFG3;                           /**< Processor 0 Configuration 3, offset: 0x38 */
  uint8_t RESERVED_1[4];
  __IO uint32_t CP1TYPE;                           /**< Processor 1 Type, offset: 0x40 */
  __IO uint32_t CP1NUM;                            /**< Processor 1 Number, offset: 0x44 */
  __IO uint32_t CP1REV;                            /**< Processor 1 Count, offset: 0x48 */
  __IO uint32_t CP1CFG0;                           /**< Processor 1 Configuration 0, offset: 0x4C */
  __IO uint32_t CP1CFG1;                           /**< Processor 1 Configuration 1, offset: 0x50 */
  __IO uint32_t CP1CFG2;                           /**< Processor 1 Configuration 2, offset: 0x54 */
  __IO uint32_t CP1CFG3;                           /**< Processor 1 Configuration 3, offset: 0x58 */
  ...
  uint8_t RESERVED_6[382];
  __IO uint16_t IRSPRC[MSCM_IRSPRC_COUNT];         /**< Interrupt Router Shared Peripheral Routing Control, array offset: 0x882, array step: 0x2 */
...
/*! @{ */
#define MSCM_IAHBCFGREG_ENET_DIS_WR_OPT_MASK     (0x1U)
#define MSCM_IAHBCFGREG_ENET_DIS_WR_OPT_SHIFT    (0U)
#define MSCM_IAHBCFGREG_ENET_DIS_WR_OPT_WIDTH    (1U)
#define MSCM_IAHBCFGREG_ENET_DIS_WR_OPT(x)       (((uint32_t)(((uint32_t)(x)) << MSCM_IAHBCFGREG_ENET_DIS_WR_OPT_SHIFT)) & MSCM_IAHBCFGREG_ENET_DIS_WR_OPT_MASK)
